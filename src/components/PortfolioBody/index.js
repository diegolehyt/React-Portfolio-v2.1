        ...
        <div className="row">
          ...
          <div className="col-md-12 col-lg-4">
            ...
            <a className="card hoverable mb-4" data-toggle="modal" data-target="#halftime" href>
              ...
              <div className="card-body">
                ...
                <h5 className="my-3">Half Time</h5>
                <p className="card-text text-uppercase mb-3">Soccer app</p>
            ...
            <a className="card hoverable mb-4" data-toggle="modal" data-target="#portfolio2" href>

              
              <img className="card-img-top" src="https://raw.githubusercontent.com/diegolehyt/Portfolio/master/images/readMe/1.png" alt="Card cap"/>


              <div className="card-body">

                <h5 className="my-3">First Portfolio</h5>
                <p className="card-text text-uppercase mb-3">first version of my portfolio</p>
          ...
          <div className="col-md-6 col-lg-4">
            ...
            <a className="card hoverable mb-4" data-toggle="modal" data-target="#googlebooks" href>
              ...
              <div className="card-body">
                ...
                <h5 className="my-3">Google Books</h5>
                <p className="card-text text-uppercase mb-3">Search and save your books</p>
          ...
          <div className="col-md-6 col-lg-4">
            ...
            <a className="card hoverable mb-4" data-toggle="modal" data-target="#weather" href>
              ...
              <img className="card-img-top" src="https://raw.githubusercontent.com/diegolehyt/React-Portfolio-v2.1/master/public/images/weather3.png" alt="Card cap"/>
